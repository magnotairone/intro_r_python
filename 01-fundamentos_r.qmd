...
Elas são usadas para converter um objeto de um tipo para outro.
...
1.  Considere os seguinte setores econômico. "Financeiro", "Tecnologia da Informação", "Bens Industriais" e "Saúde".
Gere aleatoriamente uma amostra de tamanho 1.000, com estes setores, com igual probabilidade de cada um ser escolhido. Mostre os primeiros valores da variável resultante e conte quantas empresas pertencem a cada setor econômico.
