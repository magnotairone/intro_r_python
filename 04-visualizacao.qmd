...
Algumas alterações foram feitas na forma como foram as funções do `ggplot` são usadas. Propositalmente não foi adicionado texto descritivoos pois essas alterações devem ser fáceis de interpretar. 
